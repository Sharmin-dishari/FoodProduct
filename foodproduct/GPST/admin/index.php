...
<!-- HIDDEN COLOR CHANGER -->      
  	...
  	<!--LOGO-->
	<div class="grid_8" id="logo">General Store Administration</div>
    <div class="grid_8">
<!-- USER TOOLS START -->
      <div id="user_tools"><span><a href="home22.php">Go Back</a></span></div>
    </div>
<!-- USER TOOLS END -->    
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">View Customer Information</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
		...
		<div class="portlet">
			...
			<table cellpadding="1" cellspacing="1" id="resultTable">
				...
				<?php
					...
					$result = mysqli_query($conn,"SELECT * FROM reservation ORDER BY firstname ASC");
...
Website Administration by <!--a href="../index.htm"-->Radcliffe</a></div>
<!-- FOOTER END -->
