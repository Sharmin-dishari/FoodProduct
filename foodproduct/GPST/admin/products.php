...
<!-- HIDDEN COLOR CHANGER -->      
  	...
  	<!--LOGO-->
	<div class="grid_8" id="logo">View Product Information</div>
    <div class="grid_8">
<!-- USER TOOLS START -->
      <div id="user_tools"><span><a href="home22.php">Back</a></span></div>
    </div>
<!-- USER TOOLS END -->    
							...
							while($row = mysqli_fetch_array($result))
								{
									...
									echo '<td><div align="center"><a rel="facebox" href="editproductetails.php?id='.$row['id'].'">Update?</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">Delete?</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
