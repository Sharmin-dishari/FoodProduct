...
<div id="wrapper">
	<div id="note">
		...
		For inquiries and order cancelation please contacts: 0181700992 or email us mousumimimi609@gmail.com and call on 01817615449.
	</div>
	<div id="content">
		<div id="productlist">
			...
			<?php
			require "connect.php";
			$result = mysqli_query($conn,"SELECT * FROM internet_shop");
		...
		<div id="orderlist">
			<table width="100%" border="1" cellpadding="2" cellspacing="2">
				...
				<?php
				$result3 = mysqli_query($conn,"SELECT * FROM orders WHERE confirmation='$transnum'");
				...
				<tr>
				  ...
				  <td><div align="center">
				  <?php
				  $result5 = mysqli_query($conn,"SELECT sum(total) FROM orders WHERE confirmation='$transnum'");
			...
			<?php
				  $result5 = mysqli_query($conn,"SELECT sum(qty) FROM orders WHERE confirmation='$transnum'");
					while($row5 = mysqli_fetch_array($result5))
					  { 
						echo $row5['sum(qty)']; 
					  }
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<option value="2">Shipping Inside Dhaka</option>
				<option value="3">Shipping Outside Dhaka</option>
				</select></td>
			  </tr>
			  <!--tr style="">
...
<a href="#" class="tooltip">
    ...
    <span>
        <img class="callout" src="callout.gif" />
        <strong>Free Shipping Inside Bangladesh</strong><br />
        <strong>Shipping + 500 Outside Bangladesh</strong>
    </span>
</a>
	</div>
	<div class="clearfix"></div>
