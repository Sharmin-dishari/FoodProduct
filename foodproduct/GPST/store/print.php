...
<!--img src="../images/logo.png" width="100" height="100" style="float:left;"><strong> Online Ordering System</strong><br>General Store<br>Email Us: mimi@iubat.edu<br>Contact: <a href="#">01817000987</a> and call on <a href="#">0148976112</a-->
<br><br><br><br>
<?php
include('connect.php');
		$id=$_GET['id'];
...
<table cellpadding="5" cellspacing="0" id="resultTable" border="1" width="100%">
	...
	<?php
		...
		$id=$_GET['id'];
		$results = mysqli_query($conn,"SELECT * FROM orders WHERE confirmation='$id'");
	...
	<?php
		$id=$_GET['id'];
		$resulta = mysqli_query($conn,"SELECT * FROM reservation WHERE confirmation='$id'");
